...
// //Assessment Overview Route
// export const getAssessmentOverview = () => {
//   api.get("/api/assessment/overview").then((r) => r.data)
// }
...
// // Start / resume the coding assessment
// export const startInitialCodingAssessment = (sessionId) => api
//  .post("/api/assessments/initial-coding/start", {
//       session_id: sessionId,
//     })
//     .then((r) => r.data);

// // Run code against the sample test cases
// export const runInitialCodingCode = (data) =>
//   api
//     .post("/api/assessments/initial-coding/run", data)
//     .then((r) => r.data);

// // Submit a coding solution for a question
// export const submitInitialCodingAnswer = (data) =>
//   api
//     .post("/api/assessments/initial-coding/submit", data)
//     .then((r) => r.data);

// // Complete the entire coding assessment
// export const completeInitialCodingAssessment = (sessionId) =>
//   api
//     .post("/api/assessments/initial-coding/complete", {
//       session_id: sessionId,
//     })
//     .then((r) => r.data);
...
//   api
//     .post("/api/assessments/initial-coding/activate", {
//       session_id: sessionId,
//     })
//     .then((r) => r.data);
...
//   api
//     .post("/api/assessments/initial-coding/heartbeat", {
//       session_id: sessionId,
//     })
//     .then((r) => r.data);
...
//   api
//     .post("/api/assessments/initial-coding/pause", {
//       session_id: sessionId,
//     })
//     .then((r) => r.data);
...
// // Start / resume the final quiz
// export const startFinalQuiz = () =>
//   api
//     .post("/api/assessments/final-quiz/start")
//     .then((r) => r.data);

// // Submit one final quiz answer and receive the next question
...
// }) =>
//   api
//     .post("/api/assessments/final-quiz/answer", {
//       session_id: sessionId,
//       question_id: questionId,
//       answer,
//     })
...
// // Activate / resume the final quiz timer
// export const activateFinalQuiz = (sessionId) =>
//   api
//     .post("/api/assessments/final-quiz/activate", {
//       session_id: sessionId,
//     })
//     .then((r) => r.data);

// // Send heartbeat while the final quiz is active
// export const heartbeatFinalQuiz = (sessionId) =>
//   api
//     .post("/api/assessments/final-quiz/heartbeat", {
//       session_id: sessionId,
//     })
//     .then((r) => r.data);

// // Pause the final quiz
// export const pauseFinalQuiz = (sessionId) =>
//   api
//     .post("/api/assessments/final-quiz/pause", {
//       session_id: sessionId,
//     })
//     .then((r) => r.data);
...
export const getUserProfile = (id) => api.get(`/api/users/${id}`).then((r) => r.data);
export const saveUserProfile = (id, data) => api.put(`/api/users/${id}/profile`, data).then((r) => r.data);
export const getStudentCandidates = () => api.get("/api/users/students/candidates").then((r) => r.data);
...
export const getLessonsForCourse = (courseId) => api.get(`/api/courses/${courseId}/lessons`).then((r) => r.data);
export const createLesson = (courseId, data) => api.post(`/api/courses/${courseId}/lessons`, data).then((r) => r.data);
export const getLesson = (lessonId) => api.get(`/api/lessons/lesson/${lessonId}`).then((r) => r.data);
...
// ---------------------------------------------------------
export const getMyProgress = () => api.get("/api/progress").then((r) => r.data);
export const updateProgress = (lessonId, patch) => api.patch(`/api/progress/${lessonId}`, patch).then((r) => r.data);
export const enrollCourse = (courseId) => api.post("/api/enrollments", { course_id: courseId }).then((r) => r.data);
export const getMyEnrollments = () => api.get("/api/enrollments").then((r) => r.data);
...
export const getJobs = (params = {}) => api.get("/api/jobs", { params }).then((r) => r.data);
export const createJob = (data) => api.post("/api/jobs", data).then((r) => r.data);
export const updateJob = (id, data) => api.patch(`/api/jobs/${id}`, data).then((r) => r.data);
export const deleteJob = (id) => api.delete(`/api/jobs/${id}`).then((r) => r.data);
export const applyJob = (jobId) => api.post(`/api/jobs/${jobId}/apply`).then((r) => r.data);
export const inviteCandidate = (jobId, studentId, message) =>
  api.post(`/api/jobs/${jobId}/invite`, { student_id: studentId, message }).then((r) => r.data);

export const getMyAssignments = () => api.get("/api/me/assignments").then((r) => r.data);
export const cancelAssignment = (assignmentId) => api.post(`/api/assignments/${assignmentId}/cancel`).then((r) => r.data);
export const getJobApplications = (jobId) => api.get(`/api/jobs/${jobId}/applications`).then((r) => r.data);

// ---------------------------------------------------------
// Admin, Settings & Reports API
// ---------------------------------------------------------
export const getAllUsers = (params = {}) => api.get("/api/admin/users", { params }).then((r) => r.data);
export const updateUser = (id, data) => api.patch(`/api/admin/users/${id}`, data).then((r) => r.data);
