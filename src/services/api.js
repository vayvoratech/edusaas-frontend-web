...
export const toggleCommunityLike = (postId) =>
  api.post(`/api/community/posts/${postId}/like`).then((r) => r.data);
export const getPostComments = (postId) =>
  api.get(`/api/community/posts/${postId}/comments`).then((r) => r.data);
export const addPostComment = (postId, content) =>
  api.post(`/api/community/posts/${postId}/comments`, { content }).then((r) => r.data);
